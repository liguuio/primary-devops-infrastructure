## customize
external_url 'http://git.X.Z.Y.W' # used by nginx/repo url prefix
gitlab_rails['gitlab_shell_ssh_port'] = 18002
nginx['redirect_http_to_https'] = true # only true when external_url are real addr to support http also
nginx['ssl_certificate'] = "/opt/ssl/10.211.55.7-cert.pem"
nginx['ssl_certificate_key'] = "/opt/ssl/10.211.55.7-key.pem"
nginx['http2_enabled'] = false
gitlab_rails['time_zone'] = 'Asia/Shanghai'

# mail.X.Z.Y.W
gitlab_rails['smtp_enable'] = true
gitlab_rails['smtp_address'] = "smtp.mail.X.Z.Y.W"
gitlab_rails['smtp_port'] = 25
gitlab_rails['smtp_user_name'] = "******"
gitlab_rails['smtp_password'] = "******"
gitlab_rails['smtp_domain'] = "X.Z.Y.W"
gitlab_rails['smtp_authentication'] = "login"
gitlab_rails['smtp_enable_starttls_auto'] = true
gitlab_rails['gitlab_email_from'] = 'xxx@X.Z.Y.W'
gitlab_rails['gitlab_email_reply_to'] = 'xxx@X.Z.Y.W'
gitlab_rails['gitlab_email_display_name'] = 'X.Z.Y.W GitLab'
...
# gitlab_rails['smtp_user_name'] = "xxx@outlook.com"
# gitlab_rails['smtp_password'] = "******"
...
# gitlab_rails['gitlab_email_reply_to'] = 'xxx@outlook.com'

#gitlab_rails['smtp_enable'] = true
#gitlab_rails['smtp_address'] = "X.Y.Z.W"
#gitlab_rails['smtp_port'] = 25
#gitlab_rails['smtp_user_name'] = "******"
#gitlab_rails['smtp_password'] = "******"
#gitlab_rails['smtp_domain'] = "X.Y.Z.W"
